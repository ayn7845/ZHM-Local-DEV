...
This skill is for implementation and cleanup. For broader HOI4 event wiring, use `the events skill`. For focus trees, use `hoi4-focus-trees`. For visual assets, use `the event asset skill`.
...
- relevant offline Paradox wiki pages from `paradox_wiki/`
  ...
  - Scopes
  - Data structures
- vanilla decision files from `D:\SteamLibrary\steamapps\common\Hearts of Iron IV\\`
- vanilla documentation in `D:\SteamLibrary\steamapps\common\Hearts of Iron IV\\documentation`
- existing HOI4 decision categories and scripted effects that do similar work
